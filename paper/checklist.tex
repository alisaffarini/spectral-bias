...
\item {\bf Theory assumptions and proofs}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: All experiments specify $N$, depth $L$, width $M$, number of triplets, number of seeds, and the precise data preprocessing (Sections~\ref{sec:exp-spectral}--\ref{sec:exp-end2end} and Appendix~\ref{app:impl}); raw multi-seed JSON outputs and code are included as anonymised supplementary material.
...
\item {\bf Licenses for existing assets}
    ...
    \item[] Answer: \answerYes{}
    \item[] Justification: Fashion-MNIST (MIT licence) and CIFAR-10 (publicly released by the Canadian Institute for Advanced Research) are cited via \citet{xiao2017fashion,krizhevsky2009learning}; the ImageNet-pretrained ResNet-18 / ResNet-50 backbones are from \texttt{torchvision} under the BSD-3-Clause licence (\citealp{he2016deep}).
